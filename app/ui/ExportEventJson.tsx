...
export function ExportEventJson({
  ...
  return (
    <button
      className={cn(
        "relative flex p-2 bg-neutral-100 hover:bg-neutral-200 cursor-pointer items-center justify-center rounded-md active:bg-black active:text-white group-hover:bg-neutral-200",
        className
      )}
      onClick={() => {
        setShowTooltip(true);
